app_name = "hrms"
app_title = "Quản lý Công việc & KPI"
app_publisher = "Frappe Technologies Pvt. Ltd."
app_description = "Hệ thống quản lý công việc, KPI và phân quyền nhân sự"
...
web_include_css = "/assets/hrms/css/login-lang.css"
web_include_js = "/assets/hrms/js/login-lang.js"
...
doc_events = {
	...
	"Task": {"on_update": [
			...
			"hrms.api.kpi.on_task_update",
		]},

		"KPI Scorecard": {
			"on_submit": "hrms.api.kpi.compute_scorecard_on_submit",
			"on_update": "hrms.api.kpi.compute_scorecard_on_submit",
		},
}
